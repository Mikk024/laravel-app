...
@section('content')
    <div class="mt-32 px-14 mb-20">
        <div>
            <p class="text-4xl capitalize text-center">register</p>
            <div class="bg-gray-100 rounded-md px-14 py-6 mt-6 w-1/2 mx-auto text-xl text-center flex-row justify-center">
                <form action="{{ route('register.store')}}" method="POST">
                    ...
                    <label for="name" class="capitalize">username</label>
                    <input type="text" name="name" class="block mx-auto w-1/2 mb-6 mt-2 rounded-md bg-gray-200">
                    ...
                    <label for="password_confirmation" class="capitalize">confirm password</label>
                    <input type="password" name="password_confirmation" class="block mx-auto w-1/2 mb-6 mt-2 rounded-md bg-gray-200">
